...
class Controller extends Base {
  ...
  private initialize(request: Request): [ActionType, DataTableSchema, Input[]] {
	  ...
	  // Auto[Merging]--->
    RequestHelper.registerSubmit("e6d44b49", "navigate", ["d66b23a4","e27d4c3b","8bcca5bc","3a931201","37473e1c","9d2bb91e","c085ee08","eca33837","e07e83cb","3a91a437","903420db","8ce0a253","72928a9c","d74e7c81"], {initClass: null, crossRelationUpsert: true});
    ...
    for (let i=-1; i<1024; i++) {
      input = RequestHelper.getInput(request, 'd74e7c81' + ((i == -1) ? '' : '[' + i + ']'));
