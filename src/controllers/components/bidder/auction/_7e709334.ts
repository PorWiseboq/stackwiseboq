  ...
  private initialize(request: Request): [ActionType, DataTableSchema, Input[]] {
    ...
    for (let i=-1; i<128; i++) {
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('54c30d5c', "relational", "Auction", "deliverCost");
		ValidationHelper.registerInput('54c30d5c', "Textbox 1", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, '54c30d5c' + ((i == -1) ? '' : '[' + i + ']'));
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('05733be3', "relational", "Auction", "discount");
		ValidationHelper.registerInput('05733be3', "Textbox 2", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, '05733be3' + ((i == -1) ? '' : '[' + i + ']'));
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('9d1cc748', "relational", "Auction", "vatType");
		ValidationHelper.registerInput('9d1cc748', "Radio 1", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, '9d1cc748' + ((i == -1) ? '' : '[' + i + ']'));
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('1e76478b', "relational", "Auction", "vatType");
		ValidationHelper.registerInput('1e76478b', "Radio 2", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, '1e76478b' + ((i == -1) ? '' : '[' + i + ']'));
    ...
    for (let i=-1; i<128; i++) {
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('d0422ee6', "relational", "Auction", "qid");
		ValidationHelper.registerInput('d0422ee6', "Hidden 1", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, 'd0422ee6' + ((i == -1) ? '' : '[' + i + ']'));
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('55c86c21', "relational", "Auction", "sid");
		ValidationHelper.registerInput('55c86c21', "Hidden 3", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, '55c86c21' + ((i == -1) ? '' : '[' + i + ']'));
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('32b391ac', "relational", "Auction", "cancelled");
		ValidationHelper.registerInput('32b391ac', "Hidden 2", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, '32b391ac' + ((i == -1) ? '' : '[' + i + ']'));
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('2a58dbd2', "relational", "Auction", "cancelled");
		ValidationHelper.registerInput('2a58dbd2', "Hidden 4", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, '2a58dbd2' + ((i == -1) ? '' : '[' + i + ']'));
    ...
    for (let i=-1; i<128; i++) {
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('b16eadbb', "relational", "Message", "qid");
		ValidationHelper.registerInput('b16eadbb', "Hidden 1", false, "");
    for (let i=-1; i<128; i++) {
      ...
      if (input != null) data.push(input);
		...
		RequestHelper.registerInput('a1a3c540', "relational", "Message", "sid");
		ValidationHelper.registerInput('a1a3c540', "Hidden 1", false, undefined);
    for (let i=-1; i<128; i++) {
      input = RequestHelper.getInput(this.pageId, request, 'a1a3c540' + ((i == -1) ? '' : '[' + i + ']'));
      if (input) input.value = request.session['sid'];
