...
class FlowLayout_178431b9 extends Base {
  ...
  protected render(): any {
    return (
      <div className={"internal-fsb-element " + (this.props.forward && this.props.forward.classes || '')} internal-fsb-guid="178431b9" style={Object.assign({}, this.props.forward && this.props.forward.styles || {})}>
