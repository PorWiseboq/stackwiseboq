                              ...
                              <div className="container-fluid">
                                <div className="row internal-fsb-strict-layout internal-fsb-allow-cursor">
                                  {this.getDataFromNotation("Quote", true).map((data, i) => {
                                    return (
                                      <button className="internal-fsb-element internal-fsb-allow-cursor -fsb-self-e76846ad" internal-fsb-guid="e76846ad" style={{background: (()=>{return (this.state.selectedIndex == i) ? '#007bf' : '';})(), color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}} key={"item_" + i} type="button" data-index={i + ''} onClick={((event) => { window.internalFsbSubmit('e76846ad', 'Listing', event, ((results: any) => { this.manipulate('e76846ad', 'Listing', results); }).bind(this)); }).bind(this)}>
                                  ...
                                  {this.getDataFromNotation("Quote", true).map((data, i) => {
                                    return (
                                      <button className="internal-fsb-element internal-fsb-allow-cursor -fsb-preset-e76846ad" internal-fsb-guid="802159d0" style={{'FsbInheritedPresets': 'e76846ad', background: (()=>{return (this.state.selectedIndex == i) ? '#007bf' : '';})(), color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}} key={"item_" + i} type="button" onClick={((event) => { window.internalFsbSubmit('802159d0', 'Listing', event, ((results: any) => { this.manipulate('802159d0', 'Listing', results); }).bind(this)); }).bind(this)}>
                                        ...
                                        <div className="internal-fsb-element" internal-fsb-guid="704100b7" style={{'FsbInheritedPresets': ''}}>
                                          <div className="container-fluid">
                                            <div className="row internal-fsb-strict-layout internal-fsb-allow-cursor">
                                  ...
                                  {this.getDataFromNotation("Quote", true).map((data, i) => {
                                    return (
                                      <button className="internal-fsb-element internal-fsb-allow-cursor -fsb-preset-e76846ad" internal-fsb-guid="8cbc5b17" style={{'FsbInheritedPresets': 'e76846ad', background: (()=>{return (this.state.selectedIndex == i) ? '#007bf' : '';})(), color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}} key={"item_" + i} type="button" onClick={((event) => { window.internalFsbSubmit('8cbc5b17', 'Listing', event, ((results: any) => { this.manipulate('8cbc5b17', 'Listing', results); }).bind(this)); }).bind(this)}>
                                        ...
                                        <div className="internal-fsb-element" internal-fsb-guid="1e5c65cc" style={{background: (()=>{return (this.state.selectedIndex == i) ? '#007bf' : '';})()}}>
                                          <div className="container-fluid">
                                            <div className="row internal-fsb-strict-layout internal-fsb-allow-cursor">
                                  ...
                                  {this.getDataFromNotation("Quote", true).map((data, i) => {
                                    return (
                                      <button className="internal-fsb-element internal-fsb-allow-cursor -fsb-preset-e76846ad" internal-fsb-guid="323ba37c" style={{'FsbInheritedPresets': 'e76846ad', background: (()=>{return (this.state.selectedIndex == i) ? '#007bf' : '';})(), color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}} key={"item_" + i} type="button" onClick={((event) => { window.internalFsbSubmit('323ba37c', 'Listing', event, ((results: any) => { this.manipulate('323ba37c', 'Listing', results); }).bind(this)); }).bind(this)}>
                                        ...
                                        <div className="internal-fsb-element" internal-fsb-guid="6bdca277" style={{'FsbInheritedPresets': '', background: (()=>{return (this.state.selectedIndex == i) ? '#007bf' : '';})()}}>
                                          <div className="container-fluid">
                                            <div className="row internal-fsb-strict-layout internal-fsb-allow-cursor">
