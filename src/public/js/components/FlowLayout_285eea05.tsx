...
// Auto[ClassBegin]--->
class FlowLayout_285eea05 extends Base {
  state: IState = null;
  ...
  protected render(): any {
    return pug `
      div(style=Object.assign({'borderTopWidth': '1px', 'borderTopStyle': 'solid', 'borderTopColor': 'rgba(22, 98, 250, 1)', 'paddingTop': '20px', 'paddingBottom': '20px'}, this.props.forward && this.props.forward.styles || {}) className="internal-fsb-element " + (this.props.forward && this.props.forward.classes || '') internal-fsb-guid="285eea05")
        .container-fluid
...
DeclarationHelper.declare('Site', 'Controls.FlowLayout_285eea05', FlowLayout_285eea05);
// <---Auto[ClassEnd]
