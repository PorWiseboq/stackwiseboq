                          ...
                          .container-fluid
                            .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                              .internal-fsb-element.col-2.offset-0.-fsb-preset-b6c9ad89(style={padding: '0px'}, internal-fsb-guid="12403b79")
                                input(style={'display': 'block', 'FsbInheritedPresets': 'b6c9ad89'}, ref="pickup1", onClick=this.onRadioClick_12403b79.bind(this), type="radio", name="delivery", value="true", required=true, disabled=this.state.disabled)
                          ...
                          .container-fluid
                            .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                              .internal-fsb-element.col-2.offset-0.-fsb-preset-b6c9ad89(style={padding: '0px'}, internal-fsb-guid="0606ea02")
                                input(style={'display': 'block', 'FsbInheritedPresets': 'b6c9ad89'}, ref="pickup2", onClick=this.onRadioClick_0606ea02.bind(this), type="radio", name="delivery", value="false", required=true, disabled=this.state.disabled)
