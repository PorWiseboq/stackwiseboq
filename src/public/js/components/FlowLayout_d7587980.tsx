...
// Auto[ClassBegin]--->
class FlowLayout_d7587980 extends Base {
  state: IState = null;
  ...
  protected render(): any {
    return (
      <div className={"internal-fsb-element " + (this.props.forward && this.props.forward.classes || '')} internal-fsb-guid="d7587980" style={Object.assign({}, this.props.forward && this.props.forward.styles || {})}>
...
DeclarationHelper.declare('Site', 'Controls.FlowLayout_d7587980', FlowLayout_d7587980);
// <---Auto[ClassEnd]
