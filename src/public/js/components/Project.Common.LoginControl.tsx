                          ...
                          .container-fluid
                            .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                              ...
                              .internal-fsb-element.col-12.offset-0(style={'paddingTop': '20px'}, internal-fsb-guid="437e47b4")
                                .container-fluid
                                  .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                    Button.internal-fsb-element.internal-fsb-allow-cursor.btn.btn-primary.col-12.offset-0(style={display: (()=>{return (this.state.signning_mode == 'signning_in') ? 'block' : 'none';})()}, onClick=((event) => { window.internalFsbSubmit('e968c824', 'User', event, ((results) => { this.manipulate('e968c824', 'User', results); }).bind(this)); }).bind(this), type="button", disabled=this.state.disabled, onSubmitting=this.onButtonSubmitting_e968c824.bind(this), onSubmitted=this.onButtonSubmitted_e968c824.bind(this), internal-fsb-guid="e968c824")
                                      .internal-fsb-element(internal-fsb-guid="e968c824-text")
                                        | ถัดไป
                                    Button.internal-fsb-element.internal-fsb-allow-cursor.btn.btn-primary.col-12.offset-0(style={display: (()=>{return (this.state.signning_mode == 'signning_up') ? 'block' : 'none';})()}, onClick=((event) => { window.internalFsbSubmit('da229546', 'User', event, ((results) => { this.manipulate('da229546', 'User', results); }).bind(this)); }).bind(this), type="button", disabled=this.state.disabled, onSubmitting=this.onButtonSubmitting_da229546.bind(this), onSubmitted=this.onButtonSubmitted_da229546.bind(this), internal-fsb-guid="da229546")
                                      .internal-fsb-element(internal-fsb-guid="da229546-text")
                                        | ถัดไป
    `
  }
}
DeclarationHelper.declare('Site', 'Common.LoginControl', LoginControl);
// <---Auto[ClassEnd]
