...
class Textbox_d064b129 extends Base {
  ...
  protected render(): any {
    return (
      <div className={"internal-fsb-element col-10 offset-0 " + (this.props.forward && this.props.forward.classes || '')} internal-fsb-guid="d064b129" style={Object.assign({}, this.props.forward && this.props.forward.styles || {})}>
