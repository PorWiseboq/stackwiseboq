                      ...
                      .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                        .internal-fsb-element.col-10.offset-1(style={'paddingTop': '30px', 'paddingBottom': '30px'}, internal-fsb-guid="8b9a0241")
                          ...
                          div
                            br
                          div
                            | 1. เมื่อลูกค้าประสงค์จะซื้อสินค้า WiseBOQจะส่งความต้องการซื้อสินค้านี้ไปยังเจ้าของสินค้าทุกเจ้าที่อยู่ในระบบเพื่อขอราคาสินค้า โดยWiseBOQจะนำราคาของทุกเจ้าไปเสนอราคาให้ลูกค้าในลักษณะของการประมูล
                          div
                            br
                          div
                            | 2. WiseBOQ สงวนสิทธิ์ให้ลูกค้าตัดสินใจสั่งซื้อจากเจ้าของสินค้าด้วยตัวลูกค้าเอง ซึ่งลูกค้าอาจไม่ได้เลือกจากราคาต่ำที่สุดเสมอไป เมื่อลูกค้าเลือกได้แล้ว จึงสั่งซื้อสินค้านั้นผ่านระบบของWiseBOQ
                          div
                            br
                          div
                          ...
                          div
                            br
                          div
                            | 4. WiseBOQและเจ้าของสินค้าตกลงว่า WiseBOQ จะโอนเงินค่าราคาซื้อขายสินค้าแก่เจ้าของสินค้าโดยหักค่าธรรมเนียมจัดการในอัตราร้อยละ 2.2, 1.0 หรือ 0.50 ตามที่เจ้าของสินค้าตกลงกับ WiseBOQ ของมูลค่าสุทธิของการขายสินค้าในแต่ละครั้ง (ก่อนภาษีมูลค่าเพิ่ม)
                          div
                            br
                          div
                            | หากเงินค่าซื้อขายคงเหลือเงินจำนวนเท่าใด WiseBOQจะชำระให้แก่เจ้าของสินค้าภายในตามระยะเวลาที่ตกลงกัน
                          div
                            br
                          div
                            | 5. เจ้าของสินค้าจะต้องจัดเตรียมสินค้าที่มีความถูกต้องสมบูรณ์ตามรายการคำสั่งซื้อของลูกค้า และจัดส่งให้แก่ลูกค้าในนามของWiseBOQซึ่งเป็นผู้ขาย โดยเจ้าของสินค้ารับประกันว่าสินค้ามีคุณภาพตรงตามมาตรฐานตามที่ได้ระบุหรือโฆษณาไว้ หากสินค้ามีวัสดุหรือคุณภาพไม่เป็นไปตามที่เจ้าของสินค้าได้ระบุหรือโฆษณาไว้ หรือ กรณีสินค้าที่ระบุความต้องการเป็น มอก. ต้องให้สินค้าที่ส่งเป็นไปตาม มอก. เท่านั้นเจ้าของสินค้าจะต้องยอมรับเงื่อนไขการแก้ไข หรือเปลี่ยนคืนสินค้าแก่ลูกค้าของWiseBOQ ทุกกรณี โดยไม่มีเงื่อนไขอย่างใด ๆ ทั้งสิ้น
                          div
                            br
                          div
                            | 6. เจ้าของสินค้าจะต้องทำตามเงื่อนไขการจัดส่งสินค้าอย่างเคร่งครัดตามที่ระบุไว้ในคำสั่งซื้อ หากมีความเสียหายเกิดขึ้นแก่สินค้าก่อนส่งมอบสินค้าให้แก่ลูกค้า ไม่ว่าจะเป็นเหตุสุดวิสัย หรือความประมาทเลินเล่อของบุคคลภายนอกใดก็ตามหรือเหตุอื่นใดก็ตาม เจ้าของสินค้าตกลงรับผิดชอบในความเสียหายของสินค้านั้นแก่ลูกค้าและ/หรือWiseBOQ เต็มจำนวน หรือ สามารถตกลงร่วมกันตามข้อตกลงครั้งนั้นๆ
                          div
                            br
                          div
                            | 7. กรรมสิทธิ์ในสินค้าจะโอนไปยังลูกค้าของWiseBOQ ต่อเมื่อลูกค้าได้รับมอบสินค้าครบถ้วนเรียบร้อยพร้อมเซ็นรับใบรับมอบสินค้าเรียบร้อยแล้ว
                          div
                            br
                          div
                            | 8. WiseBOQ จะโอนเงินเพื่อชำระราคาซื้อขายสินค้าแก่เจ้าของสินค้าทุก ๆ วันศุกร์ของแต่ละสัปดาห์ หากวันศุกร์ตรงกับวันหยุด จะชำระภายในวันจันทร์หรือวันที่เปิดทำงานวันแรก ทั้งนี้ โดยมีเงื่อนไขว่า เจ้าของสินค้าจะต้องแสดงเอกสารที่มีรายละเอียดถูกต้องครบถ้วนตามที่ได้ตกลงกันผ่านทางระบบของWiseBOQ คือ
                          div
                            br
                          div
                            |          a. ใบส่งสินค้าในนามของWiseB่OQมีลายเซ็นรับสินค้าของลูกค้า
                          div
                            |          b. ใบสั่งซื้อ (PO)ของWiseBOQ
                          div
                            br
                          div
                          ...
                          div
                            br
                          div
                            | 9. กรณีลูกค้าของWiseBOQ ชำระเงินค่าสินค้าผ่านทางบัตรเครดิต ลูกค้าตกลงจะเป็นผู้รับผิดชอบชำระค่าธรรมเนียมบัตรเครดิตเอง
                          div
                            br
                          div
                            | และหากกรณีมีการยกเลิกคำสั่งซื้อสินค้าอันเนื่องมาจากสินค้าไม่เป็นไปตามใบสั่งซื้อหรือสินค้ามีปัญหาหรือมีสภาพไม่สมบูรณ์ หรือ สินค้าหมดหรือขาดตลาดทำให้ไม่สามารถจัดส่งสินค้าแก่ลูกค้าได้ หรือกรณียกเลิกการซื้อขายอันมิใช่ความผิดของลูกค้า หากWiseBOQต้องคืนเงินแก่ลูกค้าเป็นเงินจำนวนเท่าใด เจ้าของสินค้าตกลงและรับประกันว่าเจ้าของสินค้าจะต้องชำระคืนเงินค่าเสียหายจำนวนดังกล่าวให้แก่WiseBOQ เต็มจำนวน
                          div
                            br
                          div
                            | 10. เจ้าของสินค้าจะส่งมอบสินค้าในนามของWiseBOQซึ่งเป็นผู้ขายให้แก่ลูกค้า ณ คลังสินค้าหรือสถานที่ที่ลูกค้ากำหนดตามใบสั่งซื้อของWiseBOQ โดยค่าใช้จ่ายในการขนส่งสินค้าลูกค้าตกลงจะเป็นผู้รับผิดชอบ ในกรณีที่ค่าขนส่งมิได้รวมอยู่ในราคาค่าสินค้า เจ้าของสินค้าจะต้องระบุราคาค่าขนส่งไว้ในใบเสนอราคาให้เป็นที่เรียบร้อยด้วย
                          div
                            br
                          div
                            | 11. ไม่ว่ากรณีใด ๆ WiseBOQ หรือเจ้าของสินค้า สามารถยกเลิกบันทึกข้อตกลงนี้ได้หากพบว่าเจ้าของสินค้า หรือWiseBOQ ไม่ปฏิบัติตามเงื่อนไขและข้อตกลงที่ได้ตกลงกัน และหากมีข้อโต้แย้งหรือข้อพิพาทอย่างใด ๆ การตัดสินของWiseBOQจะถือเป็นที่สุด
                          div
                            br
                          div
                            | 12. หากลูกค้าของWiseBOQ เรียกร้องความเสียหายอย่างใด ๆ อันเกิดจากการซื้อขายอันมิใช่ความผิดของลูกค้า และWiseBOQ จะต้องชำระค่าเสียหายดังกล่าวแก่ลูกค้า และมีการพิสูจน์ว่าเกิดจากความผิดของเจ้าของสินค้า กรณีเช่นนี้ เจ้าของสินค้าตกลงยินยอมให้WiseBOQ เรียกร้องค่าเสียหาย หรือค่าสินไหมทดแทนที่ตนต้องเสียไปคืนจากเจ้าของสินค้าได้เต็มจำนวน
