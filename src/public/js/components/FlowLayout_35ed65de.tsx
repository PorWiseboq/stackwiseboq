...
// Auto[ClassBegin]--->
class FlowLayout_35ed65de extends Base {
  state: IState = null;
  ...
  protected render(): any {
    return (
      <div className={"internal-fsb-element " + (this.props.forward && this.props.forward.classes || '')} internal-fsb-guid="35ed65de" style={Object.assign({}, this.props.forward && this.props.forward.styles || {})}>
...
DeclarationHelper.declare('Site', 'Controls.FlowLayout_35ed65de', FlowLayout_35ed65de);
// <---Auto[ClassEnd]
