...
class Rectangle_a8055802 extends Base {
  ...
  protected render(): any {
    return pug `
      div(style=Object.assign({'width': '100vw', 'height': '100vh', 'display': 'flex', 'flexDirection': 'column', 'WebkitFlexDirection': 'column', 'MsFlexDirection': 'column', 'background': 'rgba(40, 49, 69, 1)'}, this.props.forward && this.props.forward.styles || {}), className="internal-fsb-element internal-fsb-allow-cursor " + (this.props.forward && this.props.forward.classes || ''), internal-fsb-guid="a8055802")
              ...
              .container-fluid
                .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                  .internal-fsb-element.internal-fsb-allow-cursor.col-10(style={'paddingLeft': '0px', 'paddingRight': '0px', 'display': (()=>{return (this.getDataFromNotation("Quote.Auction.Message[" + i + "].type") == 0) ? 'flex' : 'none';})() || 'flex'}, internal-fsb-guid="2a02217c")
                    .internal-fsb-element(style={'background': 'rgba(255, 255, 255, 1)', 'paddingTop': '5px', 'paddingBottom': '5px', 'paddingLeft': '7px', 'paddingRight': '7px', 'borderRadius': '5px 5px 5px 5px', 'WebkitBorderRadius': '5px 5px 5px 5px', 'fontSize': '15px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote.Auction.Message[" + i + "].message"))}, internal-fsb-guid="9b681ceb")
                  .internal-fsb-element.col-10.offset-2(style={'paddingLeft': '0px', 'paddingRight': '0px', 'display': (()=>{return (this.getDataFromNotation("Quote.Auction.Message[" + i + "].type") == 1) ? 'flex' : 'none';})() || 'flex', 'flexDirection': 'row-reverse', 'WebkitFlexDirection': 'row-reverse', 'MsFlexDirection': 'row-reverse'}, internal-fsb-guid="702a908d")
                    .internal-fsb-element(style={'background': 'rgba(68, 79, 102, 1)', 'paddingTop': '5px', 'paddingBottom': '5px', 'paddingLeft': '7px', 'paddingRight': '7px', 'borderRadius': '5px 5px 5px 5px', 'WebkitBorderRadius': '5px 5px 5px 5px', 'textAlign': 'right', 'fontSize': '15px', 'color': 'rgba(255, 255, 255, 1)'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote.Auction.Message[" + i + "].message"))}, internal-fsb-guid="d1e0142d")
                ...
                .container-fluid
                  .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                    .internal-fsb-element.col-9.col-sm-10.col-md-11(style={padding: '0px'}, internal-fsb-guid="4522d52e")
                      input.form-control.form-control-md(style={'display': 'block', 'width': '100%', 'background': 'rgba(252, 252, 252, 0.15)', 'color': 'rgba(255, 255, 255, 1)', 'borderTopStyle': 'none', 'borderLeftStyle': 'none', 'borderRightStyle': 'none', 'borderBottomStyle': 'none', 'borderRadius': '20px 20px 20px 20px', 'WebkitBorderRadius': '20px 20px 20px 20px'}, ref="chatInput", type="text", required=true, placeholder="ข้อความ")
                    ...
                    Button.internal-fsb-element.internal-fsb-allow-cursor.col-3.col-sm-2.col-md-1.btn.btn-primary.btn-md(style={'borderRadius': '20px 20px 20px 20px', 'WebkitBorderRadius': '20px 20px 20px 20px'}, onClick=((event) => { window.internalFsbSubmit('a403abac', 'Message', event, ((results) => { this.manipulate('a403abac', 'Message', results); }).bind(this)); }).bind(this), type="button", onSuccess=this.onButtonSuccess_a403abac.bind(this), internal-fsb-guid="a403abac")
