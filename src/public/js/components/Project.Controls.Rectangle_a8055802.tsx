              ...
              .container-fluid
                .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                  ...
                  .internal-fsb-element.col-10.offset-2(style={'paddingLeft': '0px', 'paddingRight': '0px', 'display': (()=>{return (this.getDataFromNotation("Quote.Auction.Message[" + i + "].type") == 1) ? 'flex' : 'none';})() || 'flex', 'flexDirection': 'row-reverse', 'WebkitFlexDirection': 'row-reverse', 'MsFlexDirection': 'row-reverse'}, internal-fsb-guid="702a908d")
                    .internal-fsb-element(style={'background': 'rgba(40, 49, 69, 1)', 'paddingTop': '5px', 'paddingBottom': '5px', 'paddingLeft': '7px', 'paddingRight': '7px', 'borderRadius': '5px 5px 5px 5px', 'WebkitBorderRadius': '5px 5px 5px 5px', 'textAlign': 'right', 'fontSize': '13px', 'color': 'rgba(255, 255, 255, 1)'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote.Auction.Message[" + i + "].message"))}, internal-fsb-guid="d1e0142d")
