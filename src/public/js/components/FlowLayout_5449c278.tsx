...
class FlowLayout_5449c278 extends Base {
  ...
  protected render(): any {
    return pug `
      div(style=Object.assign({'float': 'left', 'paddingBottom': '10px'}, this.props.forward && this.props.forward.styles || {}) className="internal-fsb-element " + (this.props.forward && this.props.forward.classes || '') internal-fsb-guid="5449c278")
        .container-fluid
