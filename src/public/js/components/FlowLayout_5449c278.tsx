...
// Auto[ClassBegin]--->
class FlowLayout_5449c278 extends Base {
  state: IState = null;
  ...
  protected render(): any {
    return (
      <div className={"internal-fsb-element " + (this.props.forward && this.props.forward.classes || '')} internal-fsb-guid="5449c278" style={Object.assign({'float': 'left', 'paddingBottom': '10px'}, this.props.forward && this.props.forward.styles || {})}>
...
DeclarationHelper.declare('Site', 'Controls.FlowLayout_5449c278', FlowLayout_5449c278);
// <---Auto[ClassEnd]
