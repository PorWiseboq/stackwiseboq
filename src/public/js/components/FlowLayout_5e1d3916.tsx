...
// Auto[ClassBegin]--->
class FlowLayout_5e1d3916 extends Base {
  state: IState = null;
  ...
  protected render(): any {
    return pug `
      div(style=Object.assign({'float': 'left', 'paddingBottom': '10px'}, this.props.forward && this.props.forward.styles || {}) className="internal-fsb-element " + (this.props.forward && this.props.forward.classes || '') internal-fsb-guid="5e1d3916")
        .container-fluid
...
DeclarationHelper.declare('Site', 'Controls.FlowLayout_5e1d3916', FlowLayout_5e1d3916);
// <---Auto[ClassEnd]
