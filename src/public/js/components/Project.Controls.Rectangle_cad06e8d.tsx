...
class Rectangle_cad06e8d extends Base {
  ...
  register() {
    ...
    DataManipulationHelper.register("9868a6d5", "update", ["1832b944","b91e2739","03aab0e5","957c1568","9c338431","c22ec668","d913e6a1","c03d6613","d30aa93b","ae7e2437","a5b102c4"], {initClass: null, submitCrossType: "upsert"});
  }
  // <---Auto[ClassBegin]
