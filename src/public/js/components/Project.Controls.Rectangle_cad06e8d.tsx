                                        ...
                                        .container-fluid
                                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                            ...
                                            .internal-fsb-element.col-5.offset-0.-fsb-self-3bec5885(style={background: (()=>{return (this.hasError(i) ? '#e65100' : '');})()}, internal-fsb-guid="3bec5885")
                                              | #{this.getTag(i)}
                                            .internal-fsb-element.-fsb-self-098de259(style={display: (()=>{return (this.getNoticeCount(i) != 0) ? 'block' : 'none';})(), position: (()=>{return 'absolute !important';})()}, internal-fsb-guid="098de259")
                                        ...
                                        .container-fluid
                                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                            ...
                                            .internal-fsb-element.-fsb-preset-3bec5885.col-5(style={'FsbInheritedPresets': '3bec5885'}, internal-fsb-guid="c78396c8")
                                              | #{this.getTag(i)}
                                            .internal-fsb-element.-fsb-preset-098de259(style={'FsbInheritedPresets': '098de259', display: (()=>{return (this.getNoticeCount(i) != 0) ? 'block' : 'none';})(), position: (()=>{return 'absolute !important';})()}, internal-fsb-guid="9544ebc1")
                                              | #{this.getNoticeCount(i)}
                                        ...
                                        .container-fluid
                                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                            ...
                                            .internal-fsb-element.-fsb-preset-3bec5885.col-5(style={'FsbInheritedPresets': '3bec5885'}, internal-fsb-guid="9ec45baa")
                                              | บัตรเครดิต
                                            .internal-fsb-element.-fsb-preset-098de259(style={'FsbInheritedPresets': '098de259', display: (()=>{return (this.getNoticeCount(i) != 0) ? 'block' : 'none';})(), position: (()=>{return 'absolute !important';})()}, internal-fsb-guid="52b143be")
                                              | #{this.getNoticeCount(i)}
