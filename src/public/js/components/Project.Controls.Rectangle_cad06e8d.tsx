                      ...
                      .internal-fsb-element.col-12(style={'marginBottom': '10px', 'marginTop': '10px', 'paddingLeft': '5px', 'paddingRight': '5px'}, internal-fsb-guid="ca80140b")
                        .container-fluid
                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                            ...
                            input.internal-fsb-element(type="button", onClick=((event) => { window.internalFsbSubmit('4a579143', 'Quote', event, ((results) => { this.manipulate('4a579143', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="1", internal-fsb-guid="1ae8405a")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('4a579143', 'Quote', event, ((results) => { this.manipulate('4a579143', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="1", type="hidden", value="123", internal-fsb-guid="1921d1d6")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('4a579143', 'Quote', event, ((results) => { this.manipulate('4a579143', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="1", type="hidden", value="123", type="hidden", internal-fsb-guid="b7956268")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('4a579143', 'Quote', event, ((results) => { this.manipulate('4a579143', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="1", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="747dbd6e")
                            .internal-fsb-element.col-12(style={'textAlign': 'center', 'paddingLeft': '0px', 'paddingRight': '0px', 'color': 'rgba(255, 255, 255, 0.45)', display: (()=>{return this.getDisplayOf(QuoteType.AUCTIONING, false);})()}, type="button", onClick=((event) => { window.internalFsbSubmit('4a579143', 'Quote', event, ((results) => { this.manipulate('4a579143', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="1", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="9a91246d")
                              | เคาะประมูล
                            .internal-fsb-element.col-12(style={display: (()=>{return this.getDisplayOf(QuoteType.AUCTIONING, true);})(), padding: '0px'}, type="button", onClick=((event) => { window.internalFsbSubmit('4a579143', 'Quote', event, ((results) => { this.manipulate('4a579143', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="1", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="42b3dc9b")
                      ...
                      .internal-fsb-element.col-12(style={'marginBottom': '10px', 'paddingLeft': '5px', 'paddingRight': '5px'}, internal-fsb-guid="7b54582d")
                        .container-fluid
                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                            ...
                            input.internal-fsb-element(type="button", onClick=((event) => { window.internalFsbSubmit('c05b11c1', 'Quote', event, ((results) => { this.manipulate('c05b11c1', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="2", internal-fsb-guid="4cade2e7")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('c05b11c1', 'Quote', event, ((results) => { this.manipulate('c05b11c1', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="2", type="hidden", value="123", internal-fsb-guid="4c781bd8")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('c05b11c1', 'Quote', event, ((results) => { this.manipulate('c05b11c1', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="2", type="hidden", value="123", type="hidden", internal-fsb-guid="3d0c6a9e")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('c05b11c1', 'Quote', event, ((results) => { this.manipulate('c05b11c1', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="2", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="23ea1ac1")
                            .internal-fsb-element.col-12(style={'textAlign': 'center', 'paddingLeft': '0px', 'paddingRight': '0px', 'color': 'rgba(255, 255, 255, 0.45)', display: (()=>{return this.getDisplayOf(QuoteType.OFFERING, false);})()}, type="button", onClick=((event) => { window.internalFsbSubmit('c05b11c1', 'Quote', event, ((results) => { this.manipulate('c05b11c1', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="2", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="ac1a1bce")
                              | ประมูลผ่าน
                            .internal-fsb-element.col-12(style={display: (()=>{return this.getDisplayOf(QuoteType.OFFERING, true);})(), padding: '0px'}, type="button", onClick=((event) => { window.internalFsbSubmit('c05b11c1', 'Quote', event, ((results) => { this.manipulate('c05b11c1', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="2", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="40ada351")
                      ...
                      .internal-fsb-element.col-12(style={'marginBottom': '10px', 'paddingLeft': '5px', 'paddingRight': '5px'}, internal-fsb-guid="12a672c3")
                        .container-fluid
                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                            ...
                            input.internal-fsb-element(type="button", onClick=((event) => { window.internalFsbSubmit('833e4eb9', 'Quote', event, ((results) => { this.manipulate('833e4eb9', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="3", internal-fsb-guid="d24ed774")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('833e4eb9', 'Quote', event, ((results) => { this.manipulate('833e4eb9', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="3", type="hidden", value="123", internal-fsb-guid="80a8e675")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('833e4eb9', 'Quote', event, ((results) => { this.manipulate('833e4eb9', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="3", type="hidden", value="123", type="hidden", internal-fsb-guid="005ec895")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('833e4eb9', 'Quote', event, ((results) => { this.manipulate('833e4eb9', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="3", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="2e3b6ded")
                            .internal-fsb-element.col-12(style={'textAlign': 'center', 'paddingLeft': '0px', 'paddingRight': '0px', 'color': 'rgba(255, 255, 255, 0.45)', display: (()=>{return this.getDisplayOf(QuoteType.CHATTING, false);})()}, type="button", onClick=((event) => { window.internalFsbSubmit('833e4eb9', 'Quote', event, ((results) => { this.manipulate('833e4eb9', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="3", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="8a12a919")
                              | คุยกับลูกค้า
                            .internal-fsb-element.col-12(style={display: (()=>{return this.getDisplayOf(QuoteType.CHATTING, true);})(), padding: '0px'}, type="button", onClick=((event) => { window.internalFsbSubmit('833e4eb9', 'Quote', event, ((results) => { this.manipulate('833e4eb9', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="3", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="7eb8a313")
                            ...
                            .internal-fsb-element.col-12(style={'textAlign': 'center', 'paddingLeft': '0px', 'paddingRight': '0px', display: (()=>{return this.getDisplayOf(QuoteType.CHATTING, true);})()}, style={display: (()=>{return this.getDisplayOf(QuoteType.CHATTING, true);})(), padding: '0px'}, type="button", onClick=((event) => { window.internalFsbSubmit('833e4eb9', 'Quote', event, ((results) => { this.manipulate('833e4eb9', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="3", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="7eb8a313", internal-fsb-guid="579741b7")
                              | คุยกับลูกค้า
                      .internal-fsb-element.col-12(style={'paddingLeft': '5px', 'paddingRight': '5px'}, internal-fsb-guid="9a5131da")
                        .container-fluid
                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                            Button.internal-fsb-element.internal-fsb-allow-cursor(style={'background': 'rgba(255, 255, 255, 0)', 'borderTopStyle': 'none', 'borderLeftStyle': 'none', 'borderRightStyle': 'none', 'borderBottomStyle': 'none', 'paddingTop': '5px', 'paddingLeft': '5px', 'paddingRight': '5px', 'paddingBottom': '5px', display: (()=>{return this.getDisplayOf(QuoteType.PAID, false);})()}, type="button", onClick=((event) => { window.internalFsbSubmit('e9c9b721', 'Quote', event, ((results) => { this.manipulate('e9c9b721', 'Quote', results); }).bind(this)); }).bind(this), onSuccess=this.onButtonSuccess_e9c9b721.bind(this), onSubmitting=this.onButtonSubmitting_e9c9b721.bind(this), internal-fsb-guid="e9c9b721")
                            ...
                            input.internal-fsb-element(type="button", onClick=((event) => { window.internalFsbSubmit('e9c9b721', 'Quote', event, ((results) => { this.manipulate('e9c9b721', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="4", internal-fsb-guid="d1920261")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('e9c9b721', 'Quote', event, ((results) => { this.manipulate('e9c9b721', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="4", type="hidden", value="123", internal-fsb-guid="7a572ba4")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('e9c9b721', 'Quote', event, ((results) => { this.manipulate('e9c9b721', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="4", type="hidden", value="123", type="hidden", internal-fsb-guid="aa14b104")
                            input.internal-fsb-element.col-12(type="button", onClick=((event) => { window.internalFsbSubmit('e9c9b721', 'Quote', event, ((results) => { this.manipulate('e9c9b721', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="4", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="783a0919")
                            .internal-fsb-element.col-12(style={'textAlign': 'center', 'color': 'rgba(255, 255, 255, 0.45)', 'paddingLeft': '0px', 'paddingRight': '0px', display: (()=>{return this.getDisplayOf(QuoteType.PAID, false);})()}, type="button", onClick=((event) => { window.internalFsbSubmit('e9c9b721', 'Quote', event, ((results) => { this.manipulate('e9c9b721', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="4", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="83e40405")
                              | จ่ายเงินแล้ว
                            .internal-fsb-element.col-12.offset-0(style={display: (()=>{return this.getDisplayOf(QuoteType.PAID, true);})(), padding: '0px'}, type="button", onClick=((event) => { window.internalFsbSubmit('e9c9b721', 'Quote', event, ((results) => { this.manipulate('e9c9b721', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="4", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="86510a55")
                            ...
                            .internal-fsb-element.col-12(style={'textAlign': 'center', 'paddingLeft': '0px', 'paddingRight': '0px', display: (()=>{return this.getDisplayOf(QuoteType.PAID, true);})()}, style={display: (()=>{return this.getDisplayOf(QuoteType.PAID, true);})(), padding: '0px'}, type="button", onClick=((event) => { window.internalFsbSubmit('e9c9b721', 'Quote', event, ((results) => { this.manipulate('e9c9b721', 'Quote', results); }).bind(this)); }).bind(this), type="hidden", value="4", type="hidden", value="123", type="hidden", type="hidden", internal-fsb-guid="86510a55", internal-fsb-guid="b4775a3d")
                              | จ่ายเงินแล้ว
                        ...
                        .internal-fsb-element.col-12(style={display: (()=>{return this.getDisplayOf(QuoteType.AUCTIONING, true);})()}, internal-fsb-guid="88db4eda")
                          .container-fluid
                            .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                              ...
                              .internal-fsb-element.col-11.offset-0(style={padding: '0px'}, internal-fsb-guid="34a98650", internal-fsb-guid="5775d3be")
                                .container-fluid
                                  .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                        ...
                        .internal-fsb-element.col-12(style={display: (()=>{return this.getDisplayOf(QuoteType.OFFERING, true);})()}, internal-fsb-guid="0d656c9d")
                          .container-fluid
                            .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                              ...
                              .internal-fsb-element.col-11.offset-0(style={padding: '0px'}, internal-fsb-guid="44d05cb6", internal-fsb-guid="945cdc26")
                                .container-fluid
                                  .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                        ...
                        .internal-fsb-element.col-12(style={display: (()=>{return this.getDisplayOf(QuoteType.CHATTING, true);})()}, internal-fsb-guid="ba43b015")
                          .container-fluid
                            .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                              ...
                              .internal-fsb-element.col-11.offset-0(style={padding: '0px'}, internal-fsb-guid="694bb341", internal-fsb-guid="6daabaa5")
                                .container-fluid
                                  .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                        ...
                        .internal-fsb-element.col-12(style={display: (()=>{return this.getDisplayOf(QuoteType.PAID, true);})()}, internal-fsb-guid="2d35d6ec")
                          .container-fluid
                            .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                              ...
                              .internal-fsb-element.col-11.offset-0(style={padding: '0px'}, internal-fsb-guid="83bea00c", internal-fsb-guid="3231834e")
                                .container-fluid
                                  .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                          ...
                          .internal-fsb-element.internal-fsb-allow-cursor(style={'borderRightColor': 'rgba(22, 98, 250, 1)', 'overflowX': 'hidden', 'MsOverflowX': 'hidden', 'overflowY': 'auto', 'MsOverflowY': 'auto', 'position': 'absolute', 'top': '0px', 'left': '0px', 'bottom': '0px', 'right': '0px', 'paddingTop': '5px', 'paddingLeft': '5px', 'paddingRight': '5px'}, internal-fsb-guid="394c4745")
                                      ...
                                      .internal-fsb-element(style={'FsbInheritedPresets': '', 'background': 'rgba(214, 237, 255, 0)'}, type="hidden", value=data, internal-fsb-guid="704100b7")
                                        .container-fluid
                                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                            ...
                                            .internal-fsb-element.-fsb-preset-4aee31ab.col-7(style={'FsbInheritedPresets': '4aee31ab', color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="3945ba95")
                                              | อันดับที่ 2 / 10
                                            .internal-fsb-element.-fsb-preset-3bec5885.col-5(style={'FsbInheritedPresets': '3bec5885'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="c78396c8")
                                              | เสนอไม่ครบ
                            .internal-fsb-element.col-12(style={'paddingLeft': '0px', 'paddingRight': '0px', display: (()=>{return this.getDisplayOf(QuoteType.CHATTING, true);})()}, internal-fsb-guid="0250cb01")
                              .container-fluid
                                .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                  each data, i in this.getDataFromNotation("Quote", true)
                                    Button.internal-fsb-element.internal-fsb-allow-cursor.-fsb-preset-e76846ad(style={'FsbInheritedPresets': 'e76846ad', background: (()=>{return (this.state.selectedIndex == i) ? '#007BFF' : '';})(), color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}, key="item_" + i, type="button", onClick=((event) => { window.internalFsbSubmit('8cbc5b17', 'Listing', event, ((results) => { this.manipulate('8cbc5b17', 'Listing', results); }).bind(this)); }).bind(this), onSuccess=this.onButtonSuccess_8cbc5b17.bind(this), onSubmitting=this.onButtonSubmitting_8cbc5b17.bind(this), internal-fsb-guid="8cbc5b17")
                                      input.internal-fsb-element.col-12(type="hidden", value=this.getDataFromNotation("Quote[" + i + "].qid"), internal-fsb-guid="e8656190")
                                      .internal-fsb-element(style={'background': (()=>{return (this.state.selectedIndex == i) ? '#007bf' : '';})() || 'rgba(214, 237, 255, 0)'}, type="hidden", value=data, internal-fsb-guid="1e5c65cc")
                                        .container-fluid
                                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                            ...
                                            .internal-fsb-element.-fsb-preset-4aee31ab.col-7(style={'FsbInheritedPresets': '4aee31ab', color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="211827b2")
                                              | 150,000 บาท
                                            .internal-fsb-element.-fsb-preset-3bec5885.col-5(style={'FsbInheritedPresets': '3bec5885'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="0e8e4701")
                                              | ข้อความใหม่
                            .internal-fsb-element.col-12(style={'paddingLeft': '0px', 'paddingRight': '0px', display: (()=>{return this.getDisplayOf(QuoteType.PAID, true);})()}, internal-fsb-guid="a1595e85")
                              .container-fluid
                                .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                  each data, i in this.getDataFromNotation("Quote", true)
                                    Button.internal-fsb-element.internal-fsb-allow-cursor.-fsb-preset-e76846ad(style={'FsbInheritedPresets': 'e76846ad', background: (()=>{return (this.state.selectedIndex == i) ? '#007BFF' : '';})(), color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}, key="item_" + i, type="button", onClick=((event) => { window.internalFsbSubmit('323ba37c', 'Listing', event, ((results) => { this.manipulate('323ba37c', 'Listing', results); }).bind(this)); }).bind(this), onSuccess=this.onButtonSuccess_323ba37c.bind(this), onSubmitting=this.onButtonSubmitting_323ba37c.bind(this), internal-fsb-guid="323ba37c")
                                      input.internal-fsb-element.col-12(type="hidden", value=this.getDataFromNotation("Quote[" + i + "].qid"), internal-fsb-guid="95270ad9")
                                      .internal-fsb-element(style={'FsbInheritedPresets': '', 'background': (()=>{return (this.state.selectedIndex == i) ? '#007bf' : '';})() || 'rgba(214, 237, 255, 0)'}, type="hidden", value=data, internal-fsb-guid="6bdca277")
                                        .container-fluid
                                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                            ...
                                            .internal-fsb-element.-fsb-preset-4aee31ab.col-7(style={'FsbInheritedPresets': '4aee31ab', color: (()=>{return (this.state.selectedIndex == i) ? '#FFFFFF' : '';})()}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="39506c79")
                                              | 55,000 บาท
                                            .internal-fsb-element.-fsb-preset-3bec5885.col-5(style={'FsbInheritedPresets': '3bec5885'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="9ec45baa")
                                              | บัตรเครดิต
                                  ...
                                  .internal-fsb-element.col-12(internal-fsb-guid="64a6ac8c")
                                    .container-fluid
                                      .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                        ...
                                        .internal-fsb-element.col-12.-fsb-preset-4839e353(style={'FsbInheritedPresets': '4839e353', 'paddingLeft': '0px', 'paddingRight': '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote[#i].description"))}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote[#i].description"))}, internal-fsb-guid="7484ac1e")
                                        .internal-fsb-element.internal-fsb-allow-cursor.col-12(style={'display': 'flex', 'justifyContent': 'space-around', 'WebkitJustifyContent': 'space-around', 'marginBottom': '15px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="9ee30bae")
                                              ...
                                              .internal-fsb-element(style={'width': '100px', 'display': 'inline-block'}, key="item_" + i, internal-fsb-guid="3317ca5e")
                                                .container-fluid
                                                  .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                                    ...
                                                    .internal-fsb-element.col-12(style={display: (()=>{return (this.isMatchedRank(i)) ? 'none' : 'block';})(), padding: '0px'}, style={display: (()=>{return (this.isMatchedRank(i)) ? 'block' : 'none';})(), padding: '0px'}, internal-fsb-guid="21d1c3ed", internal-fsb-guid="cccea251")
                                                    ...
                                                    .internal-fsb-element.col-12(style={'fontSize': '12px', 'textAlign': 'center', 'paddingLeft': '0px', 'paddingRight': '0px', 'fontWeight': 'bold', 'color': (()=>{return (this.isMatchedRank(i)) ? 'rgb(22, 98, 250)' : '';})() || 'rgba(217, 217, 217, 1)', 'marginTop': '5px'}, style={display: (()=>{return (this.isMatchedRank(i)) ? 'none' : 'block';})(), padding: '0px'}, style={display: (()=>{return (this.isMatchedRank(i)) ? 'block' : 'none';})(), padding: '0px'}, internal-fsb-guid="21d1c3ed", internal-fsb-guid="cccea251", internal-fsb-guid="5022e90e")
                                                      | #{this.getRankDetail(i)}
                                        .internal-fsb-element.col-12.-fsb-self-1715aae1(dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="1715aae1")
                                          | #{this.getAuctionStatusDetail(this.state.selectedIndex)}
                                        .internal-fsb-element.col-12(style={'color': 'rgba(255, 0, 0, 1)', 'textAlign': 'center', 'marginBottom': '15px', display: (()=>{return (this.hasError(this.state.selectedIndex)) ? 'block' : 'none';})()}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="22cb5230")
                                        ...
                                        .internal-fsb-element.col-12.-fsb-preset-1715aae1(style={'FsbInheritedPresets': '1715aae1'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, type=this.getDataFromNotation('Quote[#i].substitute', false), submitting=this.state.submitting, onpricechanged=this.onPriceChanged.bind([this, i]), internal-fsb-guid="da4a5daa")
                                          | เสนอราคาใหม่ที่ราคา
                                        .internal-fsb-element.col-6.offset-3(style={padding: '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, type=this.getDataFromNotation('Quote[#i].substitute', false), submitting=this.state.submitting, onpricechanged=this.onPriceChanged.bind([this, i]), internal-fsb-guid="c03d6613")
                                        ...
                                        .internal-fsb-element.col-2.offset-0(style={padding: '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, type=this.getDataFromNotation('Quote[#i].substitute', false), submitting=this.state.submitting, onpricechanged=this.onPriceChanged.bind([this, i]), internal-fsb-guid="c03d6613", internal-fsb-guid="2b06dab6")
                                          | บาท
                                        input.internal-fsb-element.col-12(style={padding: '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, type=this.getDataFromNotation('Quote[#i].substitute', false), submitting=this.state.submitting, onpricechanged=this.onPriceChanged.bind([this, i]), internal-fsb-guid="c03d6613", type="hidden", value="", internal-fsb-guid="d30aa93b")
                                        input.internal-fsb-element.col-12(style={padding: '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote[#i].qid"))}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote[#i].qid"))}, type=this.getDataFromNotation('Quote[#i].substitute', false), submitting=this.state.submitting, onpricechanged=this.onPriceChanged.bind([this, i]), internal-fsb-guid="c03d6613", type="hidden", value="", type="hidden", value=this.getDataFromNotation("Quote[#i].qid"), internal-fsb-guid="a5b102c4")
                                        Button.internal-fsb-element.internal-fsb-allow-cursor.btn.btn-primary.btn-sm.col-4.offset-4(style={'marginTop': '10px', 'marginBottom': '10px'}, style={padding: '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, type=this.getDataFromNotation('Quote[#i].substitute', false), submitting=this.state.submitting, onpricechanged=this.onPriceChanged.bind([this, i]), internal-fsb-guid="c03d6613", type="hidden", value="", type="hidden", value=data, type="button", disabled=this.state.submitting, onClick=((event) => { window.internalFsbSubmit('9868a6d5', 'Auction', event, ((results) => { this.manipulate('9868a6d5', 'Auction', results); }).bind(this)); }).bind(this), onSuccess=this.onButtonSuccess_9868a6d5.bind(this), onSubmitting=this.onButtonSubmitting_9868a6d5.bind(this), onSubmitted=this.onButtonSubmitted_9868a6d5.bind(this), internal-fsb-guid="9868a6d5")
                            ...
                            .internal-fsb-element(style={display: (()=>{return this.getDisplayOf(QuoteType.OFFERING, true);})()}, internal-fsb-guid="51201e78")
                              .container-fluid
                                .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                  .internal-fsb-element.col-12(internal-fsb-guid="7b15e8a1")
                                    .container-fluid
                                      .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                        ...
                                        .internal-fsb-element.col-12.-fsb-preset-4839e353(style={'FsbInheritedPresets': '4839e353', 'paddingLeft': '0px', 'paddingRight': '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote.description"))}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote.description"))}, internal-fsb-guid="39ca61d5")
                                        .internal-fsb-element.col-12.-fsb-preset-1715aae1(style={'FsbInheritedPresets': '1715aae1'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="e1b315be")
                                        ...
                                        each data, i in this.getDataFromNotation("Listing", true)
                                          .internal-fsb-element.col-12.-fsb-preset-c6ba5b53(style={'FsbInheritedPresets': 'c6ba5b53', 'background': 'rgba(217, 217, 217, 1)', 'borderLeftColor': 'rgba(128, 128, 128, 1)', 'borderRightColor': 'rgba(128, 128, 128, 1)', 'borderTopColor': 'rgba(128, 128, 128, 1)', 'borderBottomColor': 'rgba(128, 128, 128, 1)'}, key="item_" + i, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, dangerouslySetInnerHTML={__html: CodeHelper.escape(data)}, internal-fsb-guid="ce9a10c5")
                                            .container-fluid
                                              .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                                .internal-fsb-element.col-4.offset-0.-fsb-preset-65ec89d1(style={'FsbInheritedPresets': '65ec89d1'}, internal-fsb-guid="19ce03e8")
                                                  .container-fluid
                                                    .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                                      ...
                                                      .internal-fsb-element.col-12(dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Listing[" + i + "].size"))}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Listing[" + i + "].size"))}, internal-fsb-guid="19d0b023")
                                                      .internal-fsb-element.col-12(dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Listing[" + i + "].quantity"))}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Listing[" + i + "].quantity"))}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Listing[" + i + "].quantity"))}, internal-fsb-guid="bd0d3bad")
                                  ...
                                  .internal-fsb-element.col-2.offset-0(style={'marginBottom': '5px'}, style={padding: '0px'}, internal-fsb-guid="e68b9c07", internal-fsb-guid="95c77e1a")
                                    | บาท
                                  .internal-fsb-element.col-6.offset-3(style={padding: '0px'}, style={padding: '0px'}, internal-fsb-guid="e68b9c07", internal-fsb-guid="dde4302b")
                                    input.form-control.form-control-sm(style={'display': 'block', 'width': '100%'}, type="text", placeholder="ส่วนลด", disabled=true)
                                  .internal-fsb-element.col-2.offset-0(style={padding: '0px'}, style={padding: '0px'}, internal-fsb-guid="e68b9c07", internal-fsb-guid="dde4302b", internal-fsb-guid="3c910e36")
                                    | บาท
                                  .internal-fsb-element.-fsb-preset-1715aae1.col-12.offset-0(style={'FsbInheritedPresets': '1715aae1'}, style={padding: '0px'}, style={padding: '0px'}, internal-fsb-guid="e68b9c07", internal-fsb-guid="dde4302b", internal-fsb-guid="5428078e")
                                    | คุณเสนอราคาที่ 125,000 บาท
                                  Button.internal-fsb-element.internal-fsb-allow-cursor.col-4.offset-4.btn.btn-danger.btn-sm(style={'marginTop': '10px', 'marginBottom': '10px'}, style={padding: '0px'}, style={padding: '0px'}, internal-fsb-guid="e68b9c07", internal-fsb-guid="dde4302b", type="button", internal-fsb-guid="d3e31c36")
