                                  ...
                                  .container-fluid
                                    .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                      .internal-fsb-element.col-12(style={'borderBottomStyle': 'solid', 'borderBottomColor': 'rgba(0, 53, 117, 1)', 'borderBottomWidth': '1px', 'paddingLeft': '0px', 'paddingRight': '0px', 'height': '65px', 'paddingTop': '3px'}, internal-fsb-guid="4741d7c7")
                                        .container-fluid
                                          .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                            .internal-fsb-element.col-12.-fsb-preset-13b0cd97(style={'fontWeight': 'bold', 'FsbInheritedPresets': '13b0cd97', 'paddingLeft': '2px', 'paddingRight': '2px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote[0].Listing.Auction[" + i + "].Substitute[" + j + "].title"))}, internal-fsb-guid="1eae4292")
                                            .internal-fsb-element.col-6.-fsb-preset-13b0cd97(style={'FsbInheritedPresets': '13b0cd97', 'paddingLeft': '2px', 'paddingRight': '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote[0].Listing.Auction[" + i + "].Substitute[" + j + "].size"))}, internal-fsb-guid="b5026407")
                                            .internal-fsb-element.col-6.-fsb-preset-13b0cd97(style={'FsbInheritedPresets': '13b0cd97', 'paddingLeft': '2px', 'paddingRight': '0px'}, dangerouslySetInnerHTML={__html: CodeHelper.escape(this.getDataFromNotation("Quote[0].Listing.Auction[" + i + "].Substitute[" + j + "].quantity"))}, internal-fsb-guid="8dca02ed")
                                            .internal-fsb-element.col-12.-fsb-preset-13b0cd97(style={'textAlign': 'center', 'FsbInheritedPresets': '13b0cd97', 'paddingLeft': '2px', 'paddingRight': '2px'}, internal-fsb-guid="d58e0636")
