                    ...
                    .container-fluid
                      .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                        ...
                        each data, i in this.getDataFromNotation("Quote[0].Auction", true)
                          .internal-fsb-element.col-12(style={'background': 'rgba(250, 250, 250, 1)', 'borderRadius': '5px 5px 5px 5px', 'WebkitBorderRadius': '5px 5px 5px 5px', 'paddingTop': '10px', 'paddingBottom': '10px', 'marginBottom': '7px', 'borderTopColor': 'rgba(217, 217, 217, 1)', 'borderTopStyle': 'solid', 'borderRightStyle': 'solid', 'borderRightColor': 'rgba(217, 217, 217, 1)', 'borderBottomStyle': 'solid', 'borderBottomColor': 'rgba(217, 217, 217, 1)', 'borderLeftColor': 'rgba(217, 217, 217, 1)', 'borderLeftStyle': 'solid', 'borderLeftWidth': '1px', 'borderRightWidth': '1px', 'borderTopWidth': '1px', 'borderBottomWidth': '1px'}, key="item_" + i, internal-fsb-guid="839d87a6")
                            .container-fluid
                              .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
