                              ...
                              .internal-fsb-element.col-12(style={'paddingLeft': '0px', 'paddingRight': '0px', 'paddingBottom': '10px'}, internal-fsb-guid="65beb763")
                                .container-fluid
                                  .row.internal-fsb-strict-layout.internal-fsb-allow-cursor
                                    ...
                                    _Project_Controls_FlowLayout_2d5ecc43_(begin=this.getDataFromNotation('Quote[0].beginAt'), showinghours=this.getDataFromNotation('Quote[0].Listing.Auction[' + i + '].showHours') || 24, auctionhours=this.getDataFromNotation('Quote[0].hoursChecked') ? this.getDataFromNotation('Quote[0].hours') : 24, cancel=this.getDataFromNotation('Quote[0].Listing.Auction[' + i + '].cancelled'))
