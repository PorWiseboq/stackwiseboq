...
// Auto[ClassBegin]--->
class FlowLayout_d700a5d4 extends Base {
  state: IState = null;
  ...
  protected render(): any {
    return pug `
      div(style=Object.assign({'borderTopWidth': '1px', 'borderTopStyle': 'solid', 'borderTopColor': 'rgba(22, 98, 250, 1)', 'paddingTop': '20px', 'paddingBottom': '20px'}, this.props.forward && this.props.forward.styles || {}) className="internal-fsb-element " + (this.props.forward && this.props.forward.classes || '') internal-fsb-guid="d700a5d4")
        .container-fluid
...
DeclarationHelper.declare('Site', 'Controls.FlowLayout_d700a5d4', FlowLayout_d700a5d4);
// <---Auto[ClassEnd]
